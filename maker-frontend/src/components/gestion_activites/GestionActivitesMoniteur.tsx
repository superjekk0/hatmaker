...
import HoraireActivite from "./activites_moniteur/HoraireActivite.tsx";

const GestionActivites = () => {
    const navigate = useNavigate();
    const [horaires, setHoraires] = useState<ActiviteMoniteur[]>([]);
    const [selectedHoraire, setSelectedHoraire] = useState<ActiviteMoniteur | null>(null);
    ...
    return (
        <div className="p-4">
            {selectedHoraire ? (
                <>
                    <HoraireActivite horaire={selectedHoraire} onBack={handleBack}/>
                </>
            ) : (
                <>
                                ...
                                <tr key={horaire.id} className="bg-white hover:bg-gray-50 border-b">
                                    ...
                                    <td className="px-6 py-4">
                                        <button
                                            ...
                                            onClick={() => navigate(`/horaire-activites/${horaire.id}`)}>
