...
public class Moniteur extends Utilisateur {
    @Builder
    public Moniteur(Long id, String nom, String courriel, String motDePasse, boolean deleted, Departement departement) {
        super(id, nom, Credentials.builder()
                .courriel(courriel)
                .motDePasse(motDePasse)
                .role(Role.MONITEUR).build(), deleted, departement);
    }
}
